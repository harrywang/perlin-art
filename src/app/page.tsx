...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-start bg-gray-100 p-4 md:p-8">
      ...
      <footer className="pt-8 pb-4 text-center text-gray-400 text-xs">
        <div className="flex items-center justify-center">
          <span>Made by&nbsp;</span>
          <a href="https://harrywang.me" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-600">
            Harry Wang
          </a>
          <a
            href="https://github.com/harrywang/perlin-art"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/data_monet/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-gray-600 ml-2"
